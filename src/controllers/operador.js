...
class OperatorController {
    ...
    GetOperators(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield operador_service_1.operatorService.GetOperator();
                return res.status(200).json(response);
            }
            catch (e) {
                (0, err_handle_1.handleHttp)(res, "Error al obtener los operadores", e.message);
            }
        });
    }
}
exports.operatorController = OperatorController.getInstance();
